    ...
    <Card>
      <div className="p-6">
        ...
        <div className="flex gap-6 mt-4 text-sm text-gray-500">
          ...
          <span>
            <strong>Prep:</strong> {receta.tiempo_preparacion} min
          </span>
          <span>
            <strong>Cocción:</strong> {receta.tiempo_coccion} min
          </span>
        </div>
      </div>
    </Card>
              ...
              <div key={idx} className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium">
                    {ri.ingrediente?.nombre ?? ri.id_ingrediente}
                  </p>
                    ...
                    <div className="mt-1">
                      ...
                      {ri.alternativas.map((alt, ai) => (
                        <p key={ai} className="text-xs text-gray-500 ml-2">
                          - {alt.ingrediente?.nombre ?? alt.id_ingrediente} -- {alt.cantidad}{' '}
                          {alt.unidad}
                        </p>
                      ))}
                    </div>
